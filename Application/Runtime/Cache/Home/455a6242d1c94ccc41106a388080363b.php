...
<div class="message-index" id="wrapper">
    <!-- <div id="scroller"> -->
        <!-- <div id="pullDown">
            <span class="pullDownIcon"></span><span class="pullDownLabel">下拉刷新...</span>
        </div> -->
        <ul class="message-list" id="thelist">
            <li>
                <div class="item-img">
                    <img src="/Public/Home/images/sf.png">
                </div>
                <div class="item-detail">
                    <p>及时填写随访信息关注您的身体状况健康每一天...</p>
            ...
            <li>
                <div class="item-img">
                    <img src="/Public/Home/images/fz.png">
                </div>
                <div class="item-detail">
                    <p>患者您好明天下午3点来我院复诊患患者您诊您好明天下午3点来我院复诊 ...</p>
                    <span>2017-02-21</span>
                </div>
                <p style="clear: both;"></p>
            </li><!-- 复诊信息盒子 -->
