                ...
                var prepareCalendar = function(){
                    ...
                    if(settings.sundayFirst) {
                        ...
                        for(i = 1; i <= monthLastDay; i++) {
                            var dayHtml = '<div class="day-item">'+
                                '<div class="day-day">' + i + '</div>' +
                                '<div class="able-num">' + 5 + '</div>'
                                '</div>';
                            // current day
                            if(moment(timeNowLocal).date(i).format("D.M.YYYY") === timeNow.format("D.M.YYYY")) {
                                html += '<td class="ic__day ic__day_state_current" day="' + i + '">' + dayHtml + '</td>';
                            } else if(timeSelected && moment(timeNowLocal).date(i).format("D.M.YYYY") === timeSelected.format("D.M.YYYY")) {
                                html += '<td class="ic__day ic__day_state_selected" day="' + i + '">' + dayHtml + '</td>';
                            } else {
                                html += '<td class="ic__day" day="' + i + '">' + dayHtml + '</td>';
                            }
                ...
                var placeCalendar = function(){
                    ...
                    if(settings.clickable) {
                        $day.on("click", function(e){
                            e.preventDefault();
                            var toDay = $(this).children().children("div").eq(0).text();
